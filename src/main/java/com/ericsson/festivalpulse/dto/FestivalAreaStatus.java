...
public class FestivalAreaStatus {
    ...
    public FestivalAreaStatus(Long id, String name, AreaType type, CrowdLevel latestLevel,
                               LocalDateTime latestTime, Double locationX, Double locationY) {
        this.id = id; this.name = name; this.type = type;
        this.latestLevel = latestLevel; this.latestTime = latestTime;
